...
"""
# create a beautiful soup object using the html above
soup2 = bs4.BeautifulSoup(paragraphs)
...
for lines in p_tags:
	print lines # lines.string = no tags
