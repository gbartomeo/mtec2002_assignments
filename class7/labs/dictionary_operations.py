...
person = {"first_name": "Gabrielle", "last_name": "Bartomeo", "favorite_food": "coconut", "eye_color": "Amber", "number_of_teeth": 30}
...
print "%s has %d teeth." % (person["first_name"], person["number_of_teeth"])

# change your favorite food
person["favorite_food"] = "rice pudding"
